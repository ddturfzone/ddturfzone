...
function doGet(e) {
  try {
    ...
    switch (action) {
      ...
      default:
        return _fail('Unknown or missing action. Supported: availability, pendingRequests, siteConfig, users, fullSync, backupStatus, backupData, importHistory, syncEvents, coaches, students, fees, enrolments, coachSettlements, dueAdjustments.');
    }
  } catch (err) {
